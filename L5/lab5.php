...
if(!empty($_SESSION["loggedIn"]) && $_SESSION["loggedIn"]===true){
	$message = '<div class="alert alert-success alert-dismissable text-center">
					...
					Thank you for login in!
				</div>';
}

$posts = getPosts();
$requiredFields=['firstName','lastName','title','comment','priority'];

if(count($_POST) > 0 && !empty($_SESSION["loggedIn"]) && $_SESSION["loggedIn"]===true)
{
...
<?php } //hide html for modal if not logged in?>

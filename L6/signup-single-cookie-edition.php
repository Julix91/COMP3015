...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	setcookie("signupdata", "$data", time() + 60*60*24*20, "/", "localhost", false, false);

} else if ($_SERVER['REQUEST_METHOD'] === 'GET') {
	if(!empty($_COOKIE['signupdata'])){

		$data = explode("@!@", $_COOKIE['signupdata']);
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
				...
				<p>FYI this solution uses only one cookie based on misreading of the POST section of the lab instructions for modifying this page ('A cookie [...] for the valueS [...] the cookie').</p>
                <?php echo $message; ?>
